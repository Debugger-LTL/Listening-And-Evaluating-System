...
public class RecyclerViewAdapter extends RecyclerView.Adapter<com.example.myapplication.ui.CommentLeader.RecyclerViewAdapter.MyViewHolder> {

    private com.example.myapplication.ui.CommentLeader.RecyclerViewAdapter.OnItemClickListener onItemClickListener;
    private RecyclerView mRecyclerView;
    private Context mContext;
    private List<com.example.myapplication.ui.CommentLeader.CardDisplay> dataSource;

    private int addDataPosition = -1;

    public void setOnItemClickListener(com.example.myapplication.ui.CommentLeader.RecyclerViewAdapter.OnItemClickListener onItemClickListener) {
    ...
    @NonNull
    @Override
    public com.example.myapplication.ui.CommentLeader.RecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.example.myapplication.ui.CommentLeader.RecyclerViewAdapter.MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.select_item_view_leader, parent, false));
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull com.example.myapplication.ui.CommentLeader.RecyclerViewAdapter.MyViewHolder holder, final int position) {
