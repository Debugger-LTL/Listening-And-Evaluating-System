...
import com.example.myapplication.ui.ScoreStu.CardDisplay;

import java.util.ArrayList;
import java.util.List;

public class RecyclerViewAdapter extends RecyclerView.Adapter<com.example.myapplication.ui.ScoreStu.RecyclerViewAdapter.MyViewHolder> {

    private com.example.myapplication.ui.ScoreStu.RecyclerViewAdapter.OnItemClickListener onItemClickListener;
    ...
    public void setOnItemClickListener(com.example.myapplication.ui.ScoreStu.RecyclerViewAdapter.OnItemClickListener onItemClickListener) {
    ...
    @NonNull
    @Override
    public com.example.myapplication.ui.ScoreStu.RecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.example.myapplication.ui.ScoreStu.RecyclerViewAdapter.MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.select_item_view, parent, false));
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull com.example.myapplication.ui.ScoreStu.RecyclerViewAdapter.MyViewHolder holder, final int position) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mTv_detail = itemView.findViewById(R.id.tv_fiveline);
            mItemView = itemView;
        }
    }
