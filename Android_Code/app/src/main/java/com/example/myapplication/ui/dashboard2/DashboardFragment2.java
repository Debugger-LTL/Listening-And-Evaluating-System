...
import com.example.myapplication.ui.WriteDiary_StuActivity.Stu_SriteDiary;
...
public class DashboardFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView=inflater.inflate(R.layout.fragment_dashboard2, null);
        UrlGetAllCourseId = getResources().getString(R.string.Dashboard_GetList_2_Stu);
    ...
    private void creatrecalview() {
        ...
        mAdapter.setOnItemClickListener(new MyRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent i;
                i = new Intent(getActivity(), Stu_SriteDiary.class);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String data = "studentId=" + TeacherId;//拼装参数
                   ...
                   // System.out.println(Gain);
                    while(matcher.find()){
                        ...
                        String teacherName = jsonObject.getString("studentsName");
                        String teacherId = jsonObject.getString("studentsId");
