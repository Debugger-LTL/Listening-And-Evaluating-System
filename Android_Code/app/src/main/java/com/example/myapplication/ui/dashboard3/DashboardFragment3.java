...
public class DashboardFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView=inflater.inflate(R.layout.fragment_dashboard3, null);

        UrlGetAllCourseId = getResources().getString(R.string.Dashboard_GetList_3);
    ...
    private void creatrecalview() {
        mRecyclerView =mView.findViewById(R.id.recycler_view_3);
            ...
            public void run() {
                ...
                try {
                    ...
                    while(matcher.find()){
                        ...
                        com.example.myapplication.ui.dashboard.Card_Detail_Dashboard temp = new com.example.myapplication.ui.dashboard.Card_Detail_Dashboard();
