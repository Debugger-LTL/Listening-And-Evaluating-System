...
public class NotificationsFragment3 extends Fragment {
    ...
    private NotificationsViewModel3 notificationsViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        notificationsViewModel =new ViewModelProvider(this).get(NotificationsViewModel3.class);
        View root = inflater.inflate(R.layout.fragment_notifications3, container, false);

        SharedPreferences sp = getActivity().getSharedPreferences("login", Context.MODE_PRIVATE);
        _name = sp.getString("name","Null");
        _sex = sp.getString("username","Null");
        _day = sp.getString("username","Null");
